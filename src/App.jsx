...
const menuData = [
  ...
  ...[
    ["وجبة شيش طاووق", 170],
    ["وجبة فراخ بانيه أو كرسبي", 160],
    ["وجبة كفتة", 140],
    ["وجبة فاهيتا فراخ", 160],
    ["وجبة تشيكن جريل", 170],
    ["وجبة سوبر زنجر", 160],
    ["طبق أرز بسمتي", 30],
  ].map((item, i) =>
  ...
  ...[
    ...
    ["قرص طعمية محشية", 6],
    ["قرص طعمية وسط 3S", 4],
    ["قرص طعمية عين كتكوت", 14],
    ["قرص عجة بلدي (1 بيضة)", 18],
    ["قرص طعمية كيري", 16],
    ["قرص طعمية موتزاريلا", 16],
    ["قرص طعمية بسطرمة وكيري", 24],
    ["قرص طعمية بسطرمة", 16],
    ["قرص طعمية جبنة مثلثات", 12],
    ["قرص طعمية ليمون معصفر", 7],
  ].map((item, i) =>
    product(
      `falafel-disk-${i}`,
      item[0],
...
const mainCategories = [
  ...
  { id: "meat-sandwiches", name: "سندوتشات لحوم" },
